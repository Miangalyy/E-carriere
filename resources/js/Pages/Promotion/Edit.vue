<template>
    ...
    <script setup>
       ...
       const form = useForm({
        titre: props.Promotions.titre,
        an_fonction_id: props.Promotions.an_fonction_id,
        nv_fonction_id: props.Promotions.nv_fonction_id
        
       })
       const soumettre = ()=>{
       form.put(route("promotion.update", {promotion: props.Promotions.id}), {
           onSuccess: (page)=>{
