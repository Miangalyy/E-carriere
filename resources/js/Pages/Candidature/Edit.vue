<template>
    ...
    <div class="detail" style="margin-top: 100px;">
      <section class="content mb-4" style="margin-right: -10px;">
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <h3 class="card-title">Modifier un candidat</h3>
            </div>
            ...
            <form @submit.prevent="soumettre">
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <select @change="recherche" v-model="form.statut" class="form-control" required>
                        <option value=""></option>
    ...
    <script setup>
       ...
       const form = useForm({
        ...
        opportunite_id: props.relier.opportunite_id,
        employer_id: props.relier.employer_id,
        statut: props.relier.statut,
        date: props.relier.date,
         
       })
       const soumettre = ()=>{
       form.put(route("candidat.update", {relier: props.relier.id}), {
           onSuccess: (page)=>{
